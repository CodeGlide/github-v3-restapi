...
func Repos_create_deployment_branch_policyHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateRepos_create_deployment_branch_policyTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_create_deployment_branch_policyHandler(cfg),
	}
}
