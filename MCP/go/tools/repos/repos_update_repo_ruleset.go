...
func Repos_update_repo_rulesetHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/rulesets/%s", cfg.BaseURL, owner, repo, ruleset_id)
...
func CreateRepos_update_repo_rulesetTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repos_owner_repo_rulesets_ruleset_id",
		mcp.WithDescription("Update a repository ruleset"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_update_repo_rulesetHandler(cfg),
	}
}
