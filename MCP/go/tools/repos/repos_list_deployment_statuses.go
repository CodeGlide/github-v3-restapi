...
func Repos_list_deployment_statusesHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		var result []models.GeneratedType_Deployment_status
...
func CreateRepos_list_deployment_statusesTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_repos_owner_repo_deployments_deployment_id_statuses_2",
		mcp.WithDescription("List deployment statuses"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Repos_list_deployment_statusesHandler(cfg),
	}
}
