...
func Actions_create_repo_variableHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/actions/variables%s", cfg.BaseURL, owner, repo, queryString)
...
func CreateActions_create_repo_variableTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_repos_owner_repo_actions_variables",
		mcp.WithDescription("Create a repository variable"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Actions_create_repo_variableHandler(cfg),
	}
}
