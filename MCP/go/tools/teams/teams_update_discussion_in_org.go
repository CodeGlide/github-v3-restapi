...
func Teams_update_discussion_in_orgHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/teams/%s/discussions/%s%s", cfg.BaseURL, org, team_slug, discussion_number, queryString)
...
func CreateTeams_update_discussion_in_orgTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("patch_orgs_org_teams_team_slug_discussions_discussion_number",
		mcp.WithDescription("Update a discussion"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Teams_update_discussion_in_orgHandler(cfg),
	}
}
