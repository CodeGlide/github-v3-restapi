...
func Code_security_get_configurationHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateCode_security_get_configurationTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_orgs_org_code-security_configurations_configuration_id_2",
		mcp.WithDescription("Get a code security configuration"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Code_security_get_configurationHandler(cfg),
	}
}
