...
func Dependabot_create_or_update_repo_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/dependabot/secrets/%s", cfg.BaseURL, owner, repo, secret_name)
...
func CreateDependabot_create_or_update_repo_secretTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repos_owner_repo_dependabot_secrets_secret_name",
	...
	return models.Tool{
		Definition: tool,
		Handler:    Dependabot_create_or_update_repo_secretHandler(cfg),
	}
}
