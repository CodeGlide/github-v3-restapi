...
func Interactions_set_restrictions_for_repoHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/repos/%s/%s/interaction-limits%s", cfg.BaseURL, owner, repo, queryString)
...
func CreateInteractions_set_restrictions_for_repoTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("put_repos_owner_repo_interaction-limits",
		mcp.WithDescription("Set interaction restrictions for a repository"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Interactions_set_restrictions_for_repoHandler(cfg),
	}
}
