...
func Codespaces_set_selected_repos_for_org_secretHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/orgs/%s/codespaces/secrets/%s/repositories", cfg.BaseURL, org, secret_name)
...
func CreateCodespaces_set_selected_repos_for_org_secretTool(cfg *config.APIConfig) models.Tool {
	...
	return models.Tool{
		Definition: tool,
		Handler:    Codespaces_set_selected_repos_for_org_secretHandler(cfg),
	}
}
